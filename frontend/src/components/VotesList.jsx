    ...
    const list = votes.map((vote) => {
        return (
            ...
            <div key={vote.id}
                ...
                <h2 className="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">{vote.id}.  {vote.vote_title}
                    </h2>
                <p className="leading-relaxed text-base mb-4">この部分いらない？</p>
                <a className="text-indigo-500 inline-flex items-center" href={`/vote/${vote.id}`}>回答する
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">ROOF PARTY
                            POLAROID</h2>
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">TOHYO
                        </h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">投票アプリだよ</p>
                    </div>


                    <section id='vote_input_area'>
                        <h2 className="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">💫新しい質問をつくる
                        </h2>
                        <div className="flex w-full justify-center items-end">
                            <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
                                <label htmlFor="hero-field"
                                       className="leading-7 text-sm text-gray-600">質問文を入力してね</label>
                    ...
                    <section>
                        <h2 className="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">💫回答する質問をえらぶ
                        </h2>
